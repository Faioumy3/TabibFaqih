...
export const Messages: React.FC<MessagesProps> = ({
  ...
  const handleSendMessage = async () => {
    ...
    const recipient = selectedRecipient || messages.find(m => m.from === selectedConversation);
    if (!recipient && !selectedConversation) return alert('خطأ');
    ...
    // الإدارة تتواصل مع الطلاب والمعلمين، والطلاب/المعلمين يتواصلون مع الإدارة فقط
