(function(){const D=document.createElement("link").relList;if(D&&D.supports&&D.supports("modulepreload"))return;for(const q of document.querySelectorAll('link[rel="modulepreload"]'))o(q);new MutationObserver(q=>{for(const Q of q)if(Q.type==="childList")for(const $ of Q.addedNodes)$.tagName==="LINK"&&$.rel==="modulepreload"&&o($)}).observe(document,{childList:!0,subtree:!0});function M(q){const Q={};return q.integrity&&(Q.integrity=q.integrity),q.referrerPolicy&&(Q.referrerPolicy=q.referrerPolicy),q.crossOrigin==="use-credentials"?Q.credentials="include":q.crossOrigin==="anonymous"?Q.credentials="omit":Q.credentials="same-origin",Q}function o(q){if(q.ep)return;q.ep=!0;const Q=M(q);fetch(q.href,Q)}})();function Cr(T){return T&&T.__esModule&&Object.prototype.hasOwnProperty.call(T,"default")?T.default:T}var ff={exports:{}},Eu={};/**
 * @license React
 ...
 */var Sr;function ny(){if(Sr)return Eu;Sr=1;var T=Symbol.for("react.transitional.element"),D=Symbol.for("react.fragment");function M(o,q,Q){var $=null;if(Q!==void 0&&($=""+Q),q.key!==void 0&&($=""+q.key),"key"in q){Q={};for(var _l in q)_l!=="key"&&(Q[_l]=q[_l])}else Q=q;return q=Q.ref,{$$typeof:T,type:o,key:$,ref:q!==void 0?q:null,props:Q}}return Eu.Fragment=D,Eu.jsx=M,Eu.jsxs=M,Eu}var _r;function iy(){return _r||(_r=1,ff.exports=ny()),ff.exports}var b=iy(),sf={exports:{}},X={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Er;function cy(){if(Er)return X;Er=1;var T=Symbol.for("react.transitional.element"),D=Symbol.for("react.portal"),M=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),q=Symbol.for("react.profiler"),Q=Symbol.for("react.consumer"),$=Symbol.for("react.context"),_l=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),V=Symbol.for("react.lazy"),H=Symbol.for("react.activity"),Z=Symbol.iterator;function vl(r){return r===null||typeof r!="object"?null:(r=Z&&r[Z]||r["@@iterator"],typeof r=="function"?r:null)}var F={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},al=Object.assign,hl={};function xl(r,x,z){this.props=r,this.context=x,this.refs=hl,this.updater=z||F}xl.prototype.isReactComponent={},xl.prototype.setState=function(r,x){if(typeof r!="object"&&typeof r!="function"&&r!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,r,x,"setState")},xl.prototype.forceUpdate=function(r){this.updater.enqueueForceUpdate(this,r,"forceUpdate")};function Hl(){}Hl.prototype=xl.prototype;function Tl(r,x,z){this.props=r,this.context=x,this.refs=hl,this.updater=z||F}var U=Tl.prototype=new Hl;U.constructor=Tl,al(U,xl.prototype),U.isPureReactComponent=!0;var Dl=Array.isArray;function w(){}var L={H:null,A:null,T:null,S:null},Ml=Object.prototype.hasOwnProperty;function Wl(r,x,z){var C=z.ref;return{$$typeof:T,type:r,key:x,ref:C!==void 0?C:null,props:z}}function pt(r,x){return Wl(r.type,x,r.props)}function mt(r){return typeof r=="object"&&r!==null&&r.$$typeof===T}function Fl(r){var x={"=":"=0",":":"=2"};return"$"+r.replace(/[=:]/g,function(z){return x[z]})}var Te=/\/+/g;function Ct(r,x){return typeof r=="object"&&r!==null&&r.key!=null?Fl(""+r.key):x.toString(36)}function At(r){switch(r.status){case"fulfilled":return r.value;case"rejected":throw r.reason;default:switch(typeof r.status=="string"?r.then(w,w):(r.status="pending",r.then(function(x){r.status==="pending"&&(r.status="fulfilled",r.value=x)},function(x){r.status==="pending"&&(r.status="rejected",r.reason=x)})),r.status){case"fulfilled":return r.value;case"rejected":throw r.reason}}throw r}function S(r,x,z,C,K){var k=typeof r;(k==="undefined"||k==="boolean")&&(r=null);var cl=!1;if(r===null)cl=!0;else switch(k){case"bigint":case"string":case"number":cl=!0;break;case"object":switch(r.$$typeof){case T:case D:cl=!0;break;case V:return cl=r._init,S(cl(r._payload),x,z,C,K)}}if(cl)return K=K(r),cl=C===""?"."+Ct(r,0):C,Dl(K)?(z="",cl!=null&&(z=cl.replace(Te,"$&/")+"/"),S(K,x,z,"",function(Oa){return Oa})):K!=null&&(mt(K)&&(K=pt(K,z+(K.key==null||r&&r.key===K.key?"":(""+K.key).replace(Te,"$&/")+"/")+cl)),x.push(K)),1;cl=0;var Jl=C===""?".":C+":";if(Dl(r))for(var Nl=0;Nl<r.length;Nl++)C=r[Nl],k=Jl+Ct(C,Nl),cl+=S(C,x,z,k,K);else if(Nl=vl(r),typeof Nl=="function")for(r=Nl.call(r),Nl=0;!(C=r.next()).done;)C=C.value,k=Jl+Ct(C,Nl++),cl+=S(C,x,z,k,K);else if(k==="object"){if(typeof r.then=="function")return S(At(r),x,z,C,K);throw x=String(r),Error("Objects are not valid as a React child (found: "+(x==="[object Object]"?"object with keys {"+Object.keys(r).join(", ")+"}":x)+"). If you meant to render a collection of children, use an array instead.")}return cl}function N(r,x,z){if(r==null)return r;var C=[],K=0;return S(r,C,"","",function(k){return x.call(z,k,K++)}),C}function G(r){if(r._status===-1){var x=r._result;x=x(),x.then(function(z){(r._status===0||r._status===-1)&&(r._status=1,r._result=z)},function(z){(r._status===0||r._status===-1)&&(r._status=2,r._result=z)}),r._status===-1&&(r._status=0,r._result=x)}if(r._status===1)return r._result.default;throw r._result}var ol=typeof reportError=="function"?reportError:function(r){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var x=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof r=="object"&&r!==null&&typeof r.message=="string"?String(r.message):String(r),error:r});if(!window.dispatchEvent(x))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",r);return}console.error(r)},yl={map:N,forEach:function(r,x,z){N(r,function(){x.apply(this,arguments)},z)},count:function(r){var x=0;return N(r,function(){x++}),x},toArray:function(r){return N(r,function(x){return x})||[]},only:function(r){if(!mt(r))throw Error("React.Children.only expected to receive a single React element child.");return r}};return X.Activity=H,X.Children=yl,X.Component=xl,X.Fragment=M,X.Profiler=q,X.PureComponent=Tl,X.StrictMode=o,X.Suspense=R,X.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=L,X.__COMPILER_RUNTIME={__proto__:null,c:function(r){return L.H.useMemoCache(r)}},X.cache=function(r){return function(){return r.apply(null,arguments)}},X.cacheSignal=function(){return null},X.cloneElement=function(r,x,z){if(r==null)throw Error("The argument must be a React element, but you passed "+r+".");var C=al({},r.props),K=r.key;if(x!=null)for(k in x.key!==void 0&&(K=""+x.key),x)!Ml.call(x,k)||k==="key"||k==="__self"||k==="__source"||k==="ref"&&x.ref===void 0||(C[k]=x[k]);var k=arguments.length-2;if(k===1)C.children=z;else if(1<k){for(var cl=Array(k),Jl=0;Jl<k;Jl++)cl[Jl]=arguments[Jl+2];C.children=cl}return Wl(r.type,K,C)},X.createContext=function(r){return r={$$typeof:$,_currentValue:r,_currentValue2:r,_threadCount:0,Provider:null,Consumer:null},r.Provider=r,r.Consumer={$$typeof:Q,_context:r},r},X.createElement=function(r,x,z){var C,K={},k=null;if(x!=null)for(C in x.key!==void 0&&(k=""+x.key),x)Ml.call(x,C)&&C!=="key"&&C!=="__self"&&C!=="__source"&&(K[C]=x[C]);var cl=arguments.length-2;if(cl===1)K.children=z;else if(1<cl){for(var Jl=Array(cl),Nl=0;Nl<cl;Nl++)Jl[Nl]=arguments[Nl+2];K.children=Jl}if(r&&r.defaultProps)for(C in cl=r.defaultProps,cl)K[C]===void 0&&(K[C]=cl[C]);return Wl(r,k,K)},X.createRef=function(){return{current:null}},X.forwardRef=function(r){return{$$typeof:_l,render:r}},X.isValidElement=mt,X.lazy=function(r){return{$$typeof:V,_payload:{_status:-1,_result:r},_init:G}},X.memo=function(r,x){return{$$typeof:p,type:r,compare:x===void 0?null:x}},X.startTransition=function(r){var x=L.T,z={};L.T=z;try{var C=r(),K=L.S;K!==null&&K(z,C),typeof C=="object"&&C!==null&&typeof C.then=="function"&&C.then(w,ol)}catch(k){ol(k)}finally{x!==null&&z.types!==null&&(x.types=z.types),L.T=x}},X.unstable_useCacheRefresh=function(){return L.H.useCacheRefresh()},X.use=function(r){return L.H.use(r)},X.useActionState=function(r,x,z){return L.H.useActionState(r,x,z)},X.useCallback=function(r,x){return L.H.useCallback(r,x)},X.useContext=function(r){return L.H.useContext(r)},X.useDebugValue=function(){},X.useDeferredValue=function(r,x){return L.H.useDeferredValue(r,x)},X.useEffect=function(r,x){return L.H.useEffect(r,x)},X.useEffectEvent=function(r){return L.H.useEffectEvent(r)},X.useId=function(){return L.H.useId()},X.useImperativeHandle=function(r,x,z){return L.H.useImperativeHandle(r,x,z)},X.useInsertionEffect=function(r,x){return L.H.useInsertionEffect(r,x)},X.useLayoutEffect=function(r,x){return L.H.useLayoutEffect(r,x)},X.useMemo=function(r,x){return L.H.useMemo(r,x)},X.useOptimistic=function(r,x){return L.H.useOptimistic(r,x)},X.useReducer=function(r,x,z){return L.H.useReducer(r,x,z)},X.useRef=function(r){return L.H.useRef(r)},X.useState=function(r){return L.H.useState(r)},X.useSyncExternalStore=function(r,x,z){return L.H.useSyncExternalStore(r,x,z)},X.useTransition=function(){return L.H.useTransition()},X.version="19.2.1",X}var xr;function vf(){return xr||(xr=1,sf.exports=cy()),sf.exports}var Kl=vf();const fy=Cr(Kl);var of={exports:{}},xu={},rf={exports:{}},df={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tr;function sy(){return Tr||(Tr=1,(function(T){function D(S,N){var G=S.length;S.push(N);l:for(;0<G;){var ol=G-1>>>1,yl=S[ol];if(0<q(yl,N))S[ol]=N,S[G]=yl,G=ol;else break l}}function M(S){return S.length===0?null:S[0]}function o(S){if(S.length===0)return null;var N=S[0],G=S.pop();if(G!==N){S[0]=G;l:for(var ol=0,yl=S.length,r=yl>>>1;ol<r;){var x=2*(ol+1)-1,z=S[x],C=x+1,K=S[C];if(0>q(z,G))C<yl&&0>q(K,z)?(S[ol]=K,S[C]=G,ol=C):(S[ol]=z,S[x]=G,ol=x);else if(C<yl&&0>q(K,G))S[ol]=K,S[C]=G,ol=C;else break l}}return N}function q(S,N){var G=S.sortIndex-N.sortIndex;return G!==0?G:S.id-N.id}if(T.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var Q=performance;T.unstable_now=function(){return Q.now()}}else{var $=Date,_l=$.now();T.unstable_now=function(){return $.now()-_l}}var R=[],p=[],V=1,H=null,Z=3,vl=!1,F=!1,al=!1,hl=!1,xl=typeof setTimeout=="function"?setTimeout:null,Hl=typeof clearTimeout=="function"?clearTimeout:null,Tl=typeof setImmediate<"u"?setImmediate:null;function U(S){for(var N=M(p);N!==null;){if(N.callback===null)o(p);else if(N.startTime<=S)o(p),N.sortIndex=N.expirationTime,D(R,N);else break;N=M(p)}}function Dl(S){if(al=!1,U(S),!F)if(M(R)!==null)F=!0,w||(w=!0,Fl());else{var N=M(p);N!==null&&At(Dl,N.startTime-S)}}var w=!1,L=-1,Ml=5,Wl=-1;function pt(){return hl?!0:!(T.unstable_now()-Wl<Ml)}function mt(){if(hl=!1,w){var S=T.unstable_now();Wl=S;var N=!0;try{l:{F=!1,al&&(al=!1,Hl(L),L=-1),vl=!0;var G=Z;try{t:{for(U(S),H=M(R);H!==null&&!(H.expirationTime>S&&pt());){var ol=H.callback;if(typeof ol=="function"){H.callback=null,Z=H.priorityLevel;var yl=ol(H.expirationTime<=S);if(S=T.unstable_now(),typeof yl=="function"){H.callback=yl,U(S),N=!0;break t}H===M(R)&&o(R),U(S)}else o(R);H=M(R)}if(H!==null)N=!0;else{var r=M(p);r!==null&&At(Dl,r.startTime-S),N=!1}}break l}finally{H=null,Z=G,vl=!1}N=void 0}}finally{N?Fl():w=!1}}}var Fl;if(typeof Tl=="function")Fl=function(){Tl(mt)};else if(typeof MessageChannel<"u"){var Te=new MessageChannel,Ct=Te.port2;Te.port1.onmessage=mt,Fl=function(){Ct.postMessage(null)}}else Fl=function(){xl(mt,0)};function At(S,N){L=xl(function(){S(T.unstable_now())},N)}T.unstable_IdlePriority=5,T.unstable_ImmediatePriority=1,T.unstable_LowPriority=4,T.unstable_NormalPriority=3,T.unstable_Profiling=null,T.unstable_UserBlockingPriority=2,T.unstable_cancelCallback=function(S){S.callback=null},T.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ml=0<S?Math.floor(1e3/S):5},T.unstable_getCurrentPriorityLevel=function(){return Z},T.unstable_next=function(S){switch(Z){case 1:case 2:case 3:var N=3;break;default:N=Z}var G=Z;Z=N;try{return S()}finally{Z=G}},T.unstable_requestPaint=function(){hl=!0},T.unstable_runWithPriority=function(S,N){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var G=Z;Z=S;try{return N()}finally{Z=G}},T.unstable_scheduleCallback=function(S,N,G){var ol=T.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ol+G:ol):G=ol,S){case 1:var yl=-1;break;case 2:yl=250;break;case 5:yl=1073741823;break;case 4:yl=1e4;break;default:yl=5e3}return yl=G+yl,S={id:V++,callback:N,priorityLevel:S,startTime:G,expirationTime:yl,sortIndex:-1},G>ol?(S.sortIndex=G,D(p,S),M(R)===null&&S===M(p)&&(al?(Hl(L),L=-1):al=!0,At(Dl,G-ol))):(S.sortIndex=yl,D(R,S),F||vl||(F=!0,w||(w=!0,Fl()))),S},T.unstable_shouldYield=pt,T.unstable_wrapCallback=function(S){var N=Z;return function(){var G=Z;Z=N;try{return S.apply(this,arguments)}finally{Z=G}}}})(df)),df}var pr;function oy(){return pr||(pr=1,rf.exports=sy()),rf.exports}var mf={exports:{}},Vl={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ar;function ry(){if(Ar)return Vl;Ar=1;var T=vf();function D(R){var p="https://react.dev/errors/"+R;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var V=2;V<arguments.length;V++)p+="&args[]="+encodeURIComponent(arguments[V])}return"Minified React error #"+R+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function M(){}var o={d:{f:M,r:function(){throw Error(D(522))},D:M,C:M,L:M,m:M,X:M,S:M,M},p:0,findDOMNode:null},q=Symbol.for("react.portal");function Q(R,p,V){var H=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:q,key:H==null?null:""+H,children:R,containerInfo:p,implementation:V}}var $=T.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function _l(R,p){if(R==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return Vl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=o,Vl.createPortal=function(R,p){var V=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(D(299));return Q(R,p,null,V)},Vl.flushSync=function(R){var p=$.T,V=o.p;try{if($.T=null,o.p=2,R)return R()}finally{$.T=p,o.p=V,o.d.f()}},Vl.preconnect=function(R,p){typeof R=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,o.d.C(R,p))},Vl.prefetchDNS=function(R){typeof R=="string"&&o.d.D(R)},Vl.preinit=function(R,p){if(typeof R=="string"&&p&&typeof p.as=="string"){var V=p.as,H=_l(V,p.crossOrigin),Z=typeof p.integrity=="string"?p.integrity:void 0,vl=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;V==="style"?o.d.S(R,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:H,integrity:Z,fetchPriority:vl}):V==="script"&&o.d.X(R,{crossOrigin:H,integrity:Z,fetchPriority:vl,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},Vl.preinitModule=function(R,p){if(typeof R=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var V=_l(p.as,p.crossOrigin);o.d.M(R,{crossOrigin:V,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&o.d.M(R)},Vl.preload=function(R,p){if(typeof R=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var V=p.as,H=_l(V,p.crossOrigin);o.d.L(R,V,{crossOrigin:H,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},Vl.preloadModule=function(R,p){if(typeof R=="string")if(p){var V=_l(p.as,p.crossOrigin);o.d.m(R,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:V,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else o.d.m(R)},Vl.requestFormReset=function(R){o.d.r(R)},Vl.unstable_batchedUpdates=function(R,p){return R(p)},Vl.useFormState=function(R,p,V){return $.H.useFormState(R,p,V)},Vl.useFormStatus=function(){return $.H.useHostTransitionStatus()},Vl.version="19.2.1",Vl}var Nr;function dy(){if(Nr)return mf.exports;Nr=1;function T(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(T)}catch(D){console.error(D)}}return T(),mf.exports=ry(),mf.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zr;function my(){if(zr)return xu;zr=1;var T=oy(),D=vf(),M=dy();function o(l){var t="https://react.dev/errors/"+l;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var e=2;e<arguments.length;e++)t+="&args[]="+encodeURIComponent(arguments[e])}return"Minified React error #"+l+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function q(l){return!(!l||l.nodeType!==1&&l.nodeType!==9&&l.nodeType!==11)}function Q(l){var t=l,e=l;if(l.alternate)for(;t.return;)t=t.return;else{l=t;do t=l,(t.flags&4098)!==0&&(e=t.return),l=t.return;while(l)}return t.tag===3?e:null}function $(l){if(l.tag===13){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function _l(l){if(l.tag===31){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function R(l){if(Q(l)!==l)throw Error(o(188))}function p(l){var t=l.alternate;if(!t){if(t=Q(l),t===null)throw Error(o(188));return t!==l?null:l}for(var e=l,a=t;;){var u=e.return;if(u===null)break;var n=u.alternate;if(n===null){if(a=u.return,a!==null){e=a;continue}break}if(u.child===n.child){for(n=u.child;n;){if(n===e)return R(u),l;if(n===a)return R(u),t;n=n.sibling}throw Error(o(188))}if(e.return!==a.return)e=u,a=n;else{for(var i=!1,c=u.child;c;){if(c===e){i=!0,e=u,a=n;break}if(c===a){i=!0,a=u,e=n;break}c=c.sibling}if(!i){for(c=n.child;c;){if(c===e){i=!0,e=n,a=u;break}if(c===a){i=!0,a=n,e=u;break}c=c.sibling}if(!i)throw Error(o(189))}}if(e.alternate!==a)throw Error(o(190))}if(e.tag!==3)throw Error(o(188));return e.stateNode.current===e?l:t}function V(l){var t=l.tag;if(t===5||t===26||t===27||t===6)return l;for(l=l.child;l!==null;){if(t=V(l),t!==null)return t;l=l.sibling}return null}var H=Object.assign,Z=Symbol.for("react.element"),vl=Symbol.for("react.transitional.element"),F=Symbol.for("react.portal"),al=Symbol.for("react.fragment"),hl=Symbol.for("react.strict_mode"),xl=Symbol.for("react.profiler"),Hl=Symbol.for("react.consumer"),Tl=Symbol.for("react.context"),U=Symbol.for("react.forward_ref"),Dl=Symbol.for("react.suspense"),w=Symbol.for("react.suspense_list"),L=Symbol.for("react.memo"),Ml=Symbol.for("react.lazy"),Wl=Symbol.for("react.activity"),pt=Symbol.for("react.memo_cache_sentinel"),mt=Symbol.iterator;function Fl(l){return l===null||typeof l!="object"?null:(l=mt&&l[mt]||l["@@iterator"],typeof l=="function"?l:null)}var Te=Symbol.for("react.client.reference");function Ct(l){if(l==null)return null;if(typeof l=="function")return l.$$typeof===Te?null:l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case al:return"Fragment";case xl:return"Profiler";case hl:return"StrictMode";case Dl:return"Suspense";case w:return"SuspenseList";case Wl:return"Activity"}if(typeof l=="object")switch(l.$$typeof){case F:return"Portal";case Tl:return l.displayName||"Context";case Hl:return(l._context.displayName||"Context")+".Consumer";case U:var t=l.render;return l=l.displayName,l||(l=t.displayName||t.name||"",l=l!==""?"ForwardRef("+l+")":"ForwardRef"),l;case L:return t=l.displayName||null,t!==null?t:Ct(l.type)||"Memo";case Ml:t=l._payload,l=l._init;try{return Ct(l(t))}catch{}}return null}var At=Array.isArray,S=D.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,N=M.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},ol=[],yl=-1;function r(l){return{current:l}}function x(l){0>yl||(l.current=ol[yl],ol[yl]=null,yl--)}function z(l,t){yl++,ol[yl]=l.current,l.current=t}var C=r(null),K=r(null),k=r(null),cl=r(null);function Jl(l,t){switch(z(k,t),z(K,l),z(C,null),t.nodeType){case 9:case 11:l=(l=t.documentElement)&&(l=l.namespaceURI)?Q0(l):0;break;default:if(l=t.tagName,t=t.namespaceURI)t=Q0(t),l=Z0(t,l);else switch(l){case"svg":l=1;break;case"math":l=2;break;default:l=0}}x(C),z(C,l)}function Nl(){x(C),x(K),x(k)}function Oa(l){l.memoizedState!==null&&z(cl,l);var t=C.current,e=Z0(t,l.type);t!==e&&(z(K,l),z(C,e))}function pu(l){K.current===l&&(x(C),x(K)),cl.current===l&&(x(cl),hu._currentValue=G)}var Zn,hf;function pe(l){if(Zn===void 0)try{throw Error()}catch(e){var t=e.stack.trim().match(/\n( *(at )?)/);Zn=t&&t[1]||"",hf=-1<e.stack.indexOf(`
    at`)?" (<anonymous>)":-1<e.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Zn+l+hf}var Vn=!1;function Kn(l,t){if(!l||Vn)return"";Vn=!0;var e=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var a={DetermineComponentFrameRoot:function(){try{if(t){var E=function(){throw Error()};if(Object.defineProperty(E.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(E,[])}catch(v){var g=v}Reflect.construct(l,[],E)}else{try{E.call()}catch(v){g=v}l.call(E.prototype)}}else{try{throw Error()}catch(v){g=v}(E=l())&&typeof E.catch=="function"&&E.catch(function(){})}}catch(v){if(v&&g&&typeof v.stack=="string")return[v.stack,g.stack]}return[null,null]}};a.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(a.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(a.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var n=a.DetermineComponentFrameRoot(),i=n[0],c=n[1];if(i&&c){var f=i.split(`
`),y=c.split(`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ey=Kl.forwardRef(({color:T="currentColor",size:D=24,strokeWidth:M=2,absoluteStrokeWidth:o,className:q="",children:Q,iconNode:$,..._l},R)=>Kl.createElement("svg",{ref:R,..._y,width:D,height:D,stroke:T,strokeWidth:o?Number(M)*24/Number(D):M,className:jr("lucide",q),...!Q&&!Sy(_l)&&{"aria-hidden":"true"},..._l},[...$.map(([p,V])=>Kl.createElement(p,V)),...Array.isArray(Q)?Q:[Q]]));/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tu=(T,D)=>{const M=Kl.forwardRef(({className:o,...q},Q)=>Kl.createElement(Ey,{ref:Q,iconNode:D,className:jr(`lucide-${hy(Dr(T))}`,`lucide-${T}`,o),...q}));return M.displayName=Dr(T),M};/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ay=[["path",{d:"M16 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z",key:"rib7q0"}],["path",{d:"M5 3a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2 1 1 0 0 1 1 1v1a2 2 0 0 1-2 2 1 1 0 0 0-1 1v2a1 1 0 0 0 1 1 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2z",key:"1ymkrd"}]],Rr=Tu("quote",Ay);/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ny=[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]],yf=Tu("send",Ny);/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zy=[["path",{d:"M11 2v2",key:"1539x4"}],["path",{d:"M5 2v2",key:"1yf1q8"}],["path",{d:"M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1",key:"rb5t3r"}],["path",{d:"M8 15a6 6 0 0 0 12 0v-3",key:"x18d4x"}],["circle",{cx:"20",cy:"10",r:"2",key:"ts1r5v"}]],Oy=Tu("stethoscope",zy);var A=(T=>(T.ICU="ICU",T.SURGERY="SURGERY",T.OBGYN="OBGYN",T.INTERNAL="INTERNAL",T.GENERAL="GENERAL",T.UNIT_8_WORSHIP="UNIT_8_WORSHIP",T))(A||{});const Ur=[{id:A.SURGERY,name:"الجراحة والتجميل",icon:"Scissors",color:"bg-blue-100 text-blue-600"},{id:A.WOMEN_PREGNANCY,name:"قضايا تتعلق بالنساء والإنجاب والأسرة",icon:"Baby",color:"bg-pink-100 text-pink-600"},{id:A.ICU_DEATH,name:"قضايا تتعلق بحالات العناية المركزة والموت",icon:"Activity",color:"bg-red-100 text-red-600"},{id:A.FASTING_MEDICINE,name:"قضايا تتعلق بالصيام والأدوية",icon:"Moon",color:"bg-yellow-100 text-yellow-600"},{id:A.ETHICS,name:"قضايا تتعلق بالأخلاقيات",icon:"Heart",color:"bg-green-100 text-green-600"},{id:A.GENETICS_REPRODUCTION,name:"قضايا تتعلق بالإنجاب والجينات",icon:"Dna",color:"bg-purple-100 text-purple-600"},{id:A.TATTOO_CORTISONE,name:"قضايا تتعلق بالوشم والاستخدام غير الطبي للكورتيزون",icon:"Zap",color:"bg-orange-100 text-orange-600"},{id:A.PRAYER_PURITY,name:"قضايا تتعلق بالصلاة والطهارة",icon:"BookOpen",color:"bg-indigo-100 text-indigo-600"},{id:A.MEDICAL_EXPERIMENTS,name:"قضايا تتعلق بالتجارب الطبية على الإنسان والحيوان",icon:"TestTube2",color:"bg-cyan-100 text-cyan-600"},{id:A.PHARMACY_DRUGS,name:"قضايا الصيدلة والأدوية",icon:"Pill",color:"bg-lime-100 text-lime-600"},{id:A.MISCELLANEOUS,name:"مسائل متنوعة",icon:"MoreHorizontal",color:"bg-gray-100 text-gray-600"}],Dy=[{id:"surg_comprehensive_cosmetic",category:A.SURGERY,title:"الأحكام الشاملة لجراحات التجميل",question:"ما هو التفصيل الشرعي الكامل في إجراء عمليات التجميل (الضرورية والتحسينية)؟",medical_context:"plastic surgery, rhinoplasty, breast augmentation, liposuction, botox, fillers, reconstruction, cosmetic, burn",ruling:`أولاً: الجراحة التجميلية الضرورية (العلاجية):
...
الحكم الشرعي النهائي: التلقيح بين الزوج والزوجة جائز شرعاً لعلاج العقم بدون وسطاء ثالثين.`,verdict:"CONDITIONAL",source:"فتوى الأزهر الشريف + مجمع الفقه الإسلامي الدولي",tags:["تلقيح","عقم","أنابيب","IVF","نسب"]},{id:"obgyn_surrogacy_forbidden",category:A.WIOMEN_PREGNANCY,title:"تأجير الأرحام / الأم البديلة (Surrogacy)",question:"ما حكم استئجار امرأة أخرى لحمل الجنين (الأم البديلة)؟",medical_context:"تأجير رحم، أم بديلة، surrogacy، حمل بالنيابة، نسب",ruling:`حكم تأجير الأرحام: حرام شرعاً وقطعياً
...
شرط الفتوى: أن يكون القرار مبنياً على تقرير طبي جماعي (ثلاثة أطباء عدول) بأن الإنعاش سيضر ولا ينفع، ولا يعتبر ذلك قتلاً رحيماً، بل هو ترك للتداوي في حالة اليأس.`,verdict:"PERMITTED",source:"اللجنة الدائمة للفتوى (فتوى رقم 12086) / فتاوى المؤتمرات الطبية الفقهية",tags:["إنعاش","DNR","توقف القلب","احتضار"]},{id:"icu_euthanasia_mercy_killing",category:A.ICU_DEATH,title:"القتل الرحيم (Euthanasia)",question:"ما حكم إنهاء حياة المريض عمداً لإراحته من الألم (القتل الرحيم)؟",medical_context:"euthanasia, mercy killing, assisted suicide, pain relief, morphine",ruling:`1. القتل الرحيم الإيجابي (Active Euthanasia):
...
يجوز إعطاء المسكنات لتخفيف الألم ولو أدى ذلك لتقصير العمر افتراضياً (كمضاعفات جانبية غير مقصودة)، بشرط أن تكون النية تسكين الألم لا قتل المريض (مبدأ الأثر المزدوج).`,verdict:"FORBIDDEN",source:"دار الإفتاء المصرية / مجمع الفقه الإسلامي",tags:["قتل رحيم","انتحار","ألم","مورفين"]},{id:"med_fasting_breakers_full",category:A.FASTING_MEDICINE,title:"المفطرات الطبية في الصيام",question:"ما هي القائمة الكاملة للأدوية والإجراءات الطبية التي تفطر والتي لا تفطر؟",medical_context:"fasting, injections, inhalers, eye drops, ear drops, suppositories, endoscopy, dialysis, anesthesia",ruling:`أولاً: ما لا يفطر (يجوز للصائم):
...
4. غض البصر ما أمكن.
وهذا جائز إجماعاً لأن حفظ النفس ورفع الألم مقصد ضروري مقدم على ستر العورة في هذه الحالة.`,verdict:"CONDITIONAL",source:"دار الإفتاء المصرية / كتب الفقه (باب التداوي)",tags:["كشف","عورة","خلوة","طبيب"]},{id:"eth_medical_secrecy",category:A.ETHICS,title:"إفشاء السر الطبي",question:"متى يجوز للطبيب إفشاء سر المريض؟",medical_context:"confidentiality, medical secrets, aids, infectious diseases, harm",ruling:`الأصل وجوب كتمان سر المريض، ويحرم إفشاؤه لأنه خيانة للأمانة، إلا في حالات استثنائية (يجوز أو يجب فيها الإفشاء) لدرء مفسدة أعظم:
...
القاعدة: "الضرر الخاص يتحمل لدفع الضرر العام".`,verdict:"CONDITIONAL",source:"ميثاق أخلاقيات الطبيب المسلم / قرارات المجامع الفقهية",tags:["سر طبي","أمانة","ضرر"]},{id:"eth_autopsy",category:A.ETHICS,title:"تشريح جثث الموتى",question:"هل يجوز تشريح الجثة للتعليم الطبي أو للبحث الجنائي؟",medical_context:"autopsy, dissection, forensic, medical education",ruling:`1. التشريح الجنائي:
...
حالات العذر:
يسقط الفرض بالكلية في حالات العجز التام (مثل الغيبوبة)، لكن يجب قضاء الصلاة بعد الشفاء إن كان الغياب مؤقتاً.`,verdict:"CONDITIONAL",source:"مجمع الفقه الإسلامي / دار الإفتاء المصرية / الأحاديث الصحيحة",tags:["صلاة","مريض","عجز","حركة"]},{id:"worship_ablution_compromise",category:A.PRAYER_PURITY,title:"الطهارة للمريض والمسح على الجبيرة",question:"كيف يتوضأ المريض الذي لا يستطيع غسل أطرافه (جبيرة، حروق، جروح)؟",medical_context:"ablution, wudu, splint, bandage, wounds, burns, tayammum",ruling:`الحكم: يجوز المسح على الجبيرة (الجبس أو الضمادات الطبية) بدلاً من الغسل.
...
الحكم الشرعي: الجمع بدون قصر هو الحكم الشرعي الصحيح للطبيب الحاضر.`,verdict:"CONDITIONAL",source:"دار الإفتاء المصرية + مركز الأزهر العالمي للفتوى + مجمع البحوث الإسلامية",tags:["صلاة","قصر","جمع","ركعات","حاضر"]},{id:"prayer_jamaa_niyyah",category:A.PRAYER_PURITY,title:"شرط النية في جمع الصلاة: متى وكيف ينوي الطبيب",question:"ما هو شرط النية في الجمع؟ ومتى يجب أن ينوي الطبيب الجمع؟",medical_context:"نية، جمع تقديم، جمع تأخير، تكبيرة إحرام، شرط صحة",ruling:`النية شرط صحة في الجمع. والتفصيل الفقهي كالتالي:
...
الحكم الشرعي: النية شرط واجب لصحة الجمع.`,verdict:"CONDITIONAL",source:"دار الإفتاء المصرية - الدكتور أحمد ممدوح",tags:["صلاة","نية","جمع","شرط صحة"]},{id:"prayer_jamaa_mowalah",category:A.PRAYER_PURITY,title:"شرط الموالاة (التتابع) في جمع الصلاة",question:"هل يجب أن تكون الصلاتان المجموعتان متتابعتان بلا فاصل؟",medical_context:"موالاة، تتابع، فاصل، صيغة الجمع، شرط",ruling:`الموالاة (التتابع) شرط في جمع التقديم عند جماهير الفقهاء.
...
الحكم الشرعي: الموالاة شرط عند كثير من الفقهاء لجمع التقديم، والأحوط الالتزام بها.`,verdict:"CONDITIONAL",source:"دار الإفتاء المصرية",tags:["صلاة","موالاة","جمع","شرط"]},{id:"prayer_jamaa_tartib",category:A.PRAYER_PURITY,title:"شرط الترتيب في الصلوات المجموعة",question:"هل يجب أن يصلي الطبيب الظهر قبل العصر والمغرب قبل العشاء؟",medical_context:"ترتيب، صلوات، ظهر، عصر، مغرب، عشاء",ruling:`الترتيب شرط واجب عند الجمهور في الجمع.
...
النتيجة: الجمع وسيلة لترشيد الموارد وحفظ المال العام، وهي علة قوية من الناحية الفقهية.`,verdict:"PERMITTED",source:"مجمع البحوث الإسلامية بالأزهر الشريف - لجنة الفتوى",tags:["صلاة","جمع","وباء","عدوى","عزل","كورونا"]},{id:"prayer_jamaa_medical_categories",category:A.PRAYER_PURITY,title:"تصنيف الكوادر الطبية وحكم كل فئة",question:"هل جميع العاملين في المستشفيات يجوز لهم الجمع؟ أم هناك فئات محددة؟",medical_context:"فئات طبية، تصنيف، عزل، العناية المركزة، فحص، كمامة",ruling:`لم تعطِ فتاوى مجمع البحوث الإسلامية حكماً تعميمياً، بل فصلت الأحكام حسب طبيعة العمل والاختلاط بالمصابين:
...
الخلاصة: الفرق هو وجود المشقة الحقيقية والعدوى المباشرة.`,verdict:"CONDITIONAL",source:"مجمع البحوث الإسلامية - لجنة الفتوى",tags:["صلاة","جمع","تصنيف","فئات طبية"]},{id:"prayer_jamaa_tahara_epidemic",category:A.PRAYER_PURITY,title:"أحكام الطهارة والوضوء عند ارتداء الملابس الواقية",question:"كيف يتوضأ الطبيب وهو يرتدي بدلات عزل كاملة؟ وماذا لو انتقض وضوؤه؟",medical_context:"طهارة، وضوء، ملابس واقية، بدلة عزل، تيمم، فاقد الطهورين",ruling:`وضعت لجنة الفتوى بمجمع البحوث الإسلامية ضوابط واضحة للطهارة في ظروف العزل:
...
الخلاصة: الصلاة مقدمة على كل شيء، والجراح معذور في ظروفه الاستثنائية.`,verdict:"CONDITIONAL",source:"دار الإفتاء المصرية - أمين الفتوى",tags:["صلاة","دم","جراح","نجاسة","ضرورة"]},{id:"prayer_jamaa_no_habit",category:A.PRAYER_PURITY,title:"عدم اتخاذ الجمع عادة يومية: الضابط الأهم",question:"هل يجوز للطبيب أن يجعل جمع الصلاة عادة يومية دائمة؟",medical_context:"جمع، عادة، يومية، رخصة، عذر، عارضة",ruling:`حذّر مركز الأزهر العالمي للفتوى الإلكترونية من تحويل الجمع إلى عادة. الشيخ أمير عبد العال: "شدد على ضرورة عدم اتخاذ ذلك الجمع باستمرار وجعله عادة يومية فهذا غير جائز"
...
الحكم الشرعي: عدم الاعتياد على الجمع شرط لجوازه، والاعتياد بلا عذر حرام.`,verdict:"CONDITIONAL",source:"مركز الأزهر العالمي للفتوى الإلكترونية - الشيخ أمير عبد العال",tags:["صلاة","جمع","عادة","رخصة","عذر"]},{id:"prayer_jamaa_taqdir_mazni",category:A.PRAYER_PURITY,title:"تقدير الطبيب للعذر: الطبيب فقيه نفسه",question:"من الذي يقرر هل الطبيب معذور في الجمع أم لا؟",medical_context:"جمع، عذر، تقدير، ضرورة، طبيب، مسؤولية",ruling:`أوضحت دار الإفتاء المصرية ومركز الأزهر العالمي مبدأً مهماً: الطبيب "فقيه نفسه" في تقدير مدى انشغاله والعذر.
...
الحكم الشرعي:
لا يجوز للصيدلي تشخيص المرض ووصف الدواء من عنده بدلاً من الطبيب. دوره يقتصر على الصرف برشة طبيب موثوقة، والنصح حول كيفية استخدام الدواء. أي تشخيص بدون طبيب يعتبر "تطبب" محرم وضامن للضرر.`,verdict:"FORBIDDEN",source:"الفقه الإسلامي (التطبب والمسؤولية) + القوانين الطبية",tags:["صيدلي","تشخيص","تطبب","مسؤولية","ضرر","طبيب"]},{id:"secrets_medical_confidentiality",category:A.MISCELLANEOUS,title:"إفشاء السر الطبي وحفظ سرية المريض",question:"متى يجوز للطبيب إفشاء سر المريض؟ وما حدود الكتمان الطبي؟",medical_context:"سر طبي، سرية، confidentiality، خصوصية، إفشاء",ruling:`الأصل الفقهي الأول: وجوب كتمان السر:
...
الحكم الشرعي:
جائز المسح على الخفين والجوارب بشروطها (لبس على طهارة، سترة، طهارة)، ومدته يوم وليلة للمقيم وثلاثة أيام للمسافر. وهذا تيسير من الشريعة ورفع للحرج.`,verdict:"PERMITTED",source:"جمهور الفقهاء (الحنفية، المالكية، الشافعية، الحنابلة)",tags:["وضوء","مسح","جوارب","خفين","طهارة"]},{id:"u8_menstruation_quran",category:A.MISCELLANEOUS,title:"قراءة الحائض للقرآن",question:"هل يجوز للحائض قراءة القرآن (للطالبة/المعلمة الطبيبة)؟",medical_context:"menstruation, quran, reading, حيض، قرآن",ruling:`المشكلة الطبية والشرعية:
...
- الاستحقاق: الفقراء والمساكين والأعمال الخيرية الإسلامية`,verdict:"CONDITIONAL",source:"فقه الزكاة + ابن قدامة + الشيخ ابن عثيمين",tags:["زكاة","مال","نصاب","دخل","راتب","عيادة"]}],My=(T,D)=>{const M=[];for(let o=0;o<=D.length;o++)M[o]=[o];for(let o=0;o<=T.length;o++)M[0][o]=o;for(let o=1;o<=D.length;o++)for(let q=1;q<=T.length;q++)D.charAt(o-1)===T.charAt(q-1)?M[o][q]=M[o-1][q-1]:M[o][q]=Math.min(M[o-1][q-1]+1,M[o][q-1]+1,M[o-1][q]+1);return M[D.length][T.length]},gf=(T,D)=>{const M=Math.max(T.length,D.length);return M===0?1:1-My(T,D)/M},za=T=>T?T.toLowerCase().normalize("NFKD").replace(/[\u064B-\u0652\u0640]/g,"").replace(/[أإآ]/g,"ا").replace(/ى/g,"ي").replace(/ة/g,"ه").replace(/[^\u0600-\u06FF0-9\s]/g," ").split(/\s+/).filter(Boolean):[],Ry=(T,D)=>{const M=za(T),o=T.toLowerCase().trim(),q=/^[a-z\s]+$/i.test(o),Q=za(D.title),$=za(D.question||""),_l=za(D.medical_context||""),R=za((D.tags||[]).join(" ")),p=za(D.ruling||""),V=(D.medical_context||"").toLowerCase(),H=(D.tags||[]).join(" ").toLowerCase();let Z=0,vl=!1;if(q&&o.length>0){V.includes(o)&&(Z+=20,vl=!0),H.includes(o)&&(Z+=15,vl=!0);const F=o.split(/\s+/).filter(hl=>hl.length>2);if(F.length===0)return 0;let al=0;for(const hl of F)V.includes(hl)?(Z+=12,al++):H.includes(hl)&&(Z+=10,al++);if(vl=al>0,!vl){const hl=V.split(/[\s,()/-]+/);for(const xl of F)for(const Hl of hl)if(Hl.length>2){const Tl=gf(xl,Hl);Tl>.78&&(Z+=3+2*Tl)}}}else{if(!M.length)return 0;let F=0;for(const al of M)al.length<2||(_l.includes(al)?(Z+=14,F++):Q.includes(al)?(Z+=11,F++):R.includes(al)?(Z+=9,F++):$.includes(al)&&(Z+=7,F++));if(vl=F>0,!vl){for(const al of M)if(!(al.length<2)){for(const hl of _l)if(hl.length>2){const xl=gf(al,hl);xl>.8&&(Z+=3+2*xl)}for(const hl of R)if(hl.length>2){const xl=gf(al,hl);xl>.8&&(Z+=2+1.5*xl)}}}if(Z===0)for(const al of M)p.includes(al)&&(Z+=2)}return Z||0},Uy=(T,D)=>D.map(o=>({fatwa:o,score:Ry(T,o)})).filter(o=>o.score>3).sort((o,q)=>q.score-o.score).map(o=>o.fatwa).slice(0,5),Cy=()=>{var Tl;const[T]=Kl.useState(Dy),[D,M]=Kl.useState([]),[o,q]=Kl.useState(""),Q=!1,[$,_l]=Kl.useState(!1),[R,p]=Kl.useState(!1),[V,H]=Kl.useState(null),[Z,vl]=Kl.useState("chat"),[F,al]=Kl.useState(null),hl=Kl.useRef(null),xl=()=>{const U=hl.current;U&&(U.scrollTop=U.scrollHeight)};Kl.useEffect(()=>{xl()},[D,$]);const Hl=async()=>{if(!o.trim())return;const U=o,Dl={id:Date.now().toString(),role:"user",text:U,isEmergency:Q};M(w=>[...w,Dl]),q(""),_l(!0);try{let w=[],L="";const Ml=Uy(U,T);if(Ml.length>0){w=Ml.map(mt=>mt.id);const pt=Ml.length;pt===1?L="ها هي الفتوى عزيزي الطبيب":L=`ها هي ${pt} فتاوى مرتبطة بسؤالك من مصادر متعددة:`}else L="عذرًا، لم أجد فتوى مطابقة لهذا السؤال في قاعدة البيانات الحالية.";const Wl={id:(Date.now()+1).toString(),role:"model",text:L,isEmergency:Q,relatedFatwaIds:w};M(pt=>[...pt,Wl])}catch(w){console.error(w),M(L=>[...L,{id:(Date.now()+1).toString(),role:"model",text:"عذرًا، حدث خطأ غير متوقَّع."}])}finally{_l(!1)}};return b.jsxs("div",{className:"flex flex-col h-[100dvh] bg-slate-50 text-slate-800 font-tajawal overflow-hidden",children:[b.jsx("header",{className:"px-5 py-4 bg-white border-b border-gray-100 shadow-sm flex items-center justify-center relative z-20",children:b.jsxs("div",{className:"flex flex-col items-center gap-1",children:[b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx("div",{className:"p-1.5 rounded-lg bg-teal-50",children:b.jsx(Oy,{className:"w-6 h-6 text-teal-700"})}),b.jsx("h1",{className:"text-2xl font-bold font-amiri text-gray-900 leading-none",children:"الطــبيب الفقيــه"})]}),b.jsx("span",{className:"text-sm text-teal-600 font-ruqaa opacity-90 tracking-wide transform -translate-y-2",children:"(بين الطب والشريعة)"})]})}),b.jsxs("main",{className:"flex-1 flex flex-col relative overflow-hidden",children:[b.jsx("div",{className:"absolute inset-0 z-0 opacity-[0.03] pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/arabesque.png')]"}),Z==="chat"&&b.jsxs("section",{className:"flex-1 flex flex-col relative z-10 w-full mx-auto max-w-lg md:max-w-2xl",children:[b.jsxs("div",{ref:hl,className:"flex-1 overflow-y-auto p-3 md:p-5 space-y-6 pb-80 scrollbar-hide",children:[D.length===0&&b.jsx("div",{className:"flex flex-col items-center justify-center min-h-[50vh] text-center mt-2 px-2",children:b.jsxs("div",{className:"w-full space-y-6 animate-in fade-in zoom-in duration-700",children:[b.jsx("div",{className:"flex justify-center",children:b.jsx("div",{className:"bg-gradient-to-tr from-teal-50 to-white p-4 rounded-full shadow-sm ring-1 ring-gray-100",children:b.jsx(py,{className:"w-10 h-10 text-teal-600"})})}),b.jsxs("div",{className:"space-y-2",children:[b.jsx("h2",{className:"text-xl font-bold text-gray-800 font-amiri",children:"السلام عليكم دكتور"}),b.jsx("p",{className:"text-xs text-gray-500 max-w-xs mx-auto leading-relaxed",children:"صلّ على سيدنا النبي ﷺ خير معلم الناس الخير."})]}),b.jsxs("div",{className:"grid grid-cols-1 gap-3 w-full",children:[b.jsxs("div",{className:"relative overflow-hidden bg-white p-4 rounded-xl border border-teal-100 shadow-sm text-right",children:[b.jsx(Rr,{className:"absolute -bottom-2 -left-2 w-12 h-12 text-teal-50 opacity-50 rotate-12"}),b.jsx("p",{className:"text-gray-800 font-amiri text-base font-medium leading-relaxed mb-2 relative z-10",children:'"لا أعلم علمًا بعد الحلال والحرام أنبل من الطب"'}),b.jsx("span",{className:"text-xs font-bold text-teal-600 block relative z-10",children:"- الإمام الشافعي"})]}),b.jsxs("div",{className:"relative overflow-hidden bg-white p-4 rounded-xl border border-blue-100 shadow-sm text-right",children:[b.jsx(Rr,{className:"absolute -bottom-2 -left-2 w-12 h-12 text-blue-50 opacity-50 rotate-12"}),b.jsx("p",{className:"text-gray-800 font-amiri text-base font-medium leading-relaxed mb-2 relative z-10",children:'"عليّ أن أتسلح بالعلم؛ لأجابه هذا العدو البغيض الذي يفتك ببنيان الله المقدس"'}),b.jsx("span",{className:"text-xs font-bold text-teal-600 block relative z-10",children:"- أبو بكر الرازي"})]})]})]})}),D.map(U=>{const Dl=(U.relatedFatwaIds||[]).map(w=>T.find(L=>L.id===w)).filter(w=>w!==void 0);return b.jsxs("div",{className:`flex w-full flex-col gap-2 ${U.role==="user"?"items-end":"items-start"}`,children:[U.role==="user"&&b.jsx("div",{className:"bg-teal-600 text-white px-4 py-2.5 rounded-2xl rounded-tr-sm shadow-md max-w-[85%]",children:b.jsx("p",{className:"text-base",children:U.text})}),U.role==="model"&&b.jsxs("div",{className:"w-full animate-in slide-in-from-bottom-2 duration-500",children:[Dl.length===0&&b.jsx("div",{className:"bg-white px-4 py-3 rounded-2xl rounded-tl-sm shadow-sm border border-gray-100 text-gray-800 max-w-[90%] mb-2",children:b.jsx("p",{className:"text-sm leading-relaxed",children:U.text})}),Dl.length>0&&b.jsx("div",{className:"bg-white px-4 py-3 rounded-2xl rounded-tl-sm shadow-sm border border-gray-100 text-gray-800 max-w-[90%] mb-3",children:b.jsx("p",{className:"text-sm leading-relaxed",children:U.text})}),Dl.map((w,L)=>b.jsxs("div",{className:"w-full rounded-xl shadow-md overflow-hidden border border-gray-200 bg-white mb-3",children:[b.jsxs("div",{className:"px-4 py-3 border-b flex justify-between items-center bg-gradient-to-r from-teal-50 to-blue-50 border-gray-100",children:[b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx(Mr,{className:"w-4 h-4 text-teal-600"}),b.jsxs("span",{className:"text-xs font-bold text-teal-700",children:["فتوى ",Dl.length>1?`${L+1} من ${Dl.length}`:"تفصيلية"]})]}),b.jsx("span",{className:"text-[11px] text-teal-700 bg-white/70 px-2 py-1 rounded font-semibold",children:w.source})]}),b.jsxs("div",{className:"p-4 space-y-4",children:[b.jsx("h3",{className:"font-bold text-lg font-amiri leading-snug text-gray-900 border-r-4 border-teal-600 pr-3",children:w.title}),b.jsxs("div",{className:"bg-amber-50/50 rounded p-3 border border-amber-100/50",children:[b.jsx("p",{className:"text-xs font-bold text-amber-800 mb-2",children:"❓ السؤال:"}),b.jsx("p",{className:"text-sm text-amber-900 leading-relaxed",children:w.question})]}),w.medical_context&&b.jsxs("div",{className:"bg-blue-50/50 rounded p-3 border border-blue-100/50",children:[b.jsx("p",{className:"text-xs font-bold text-blue-800 mb-2",children:"🏥 السياق الطبي:"}),b.jsx("p",{className:"text-sm text-blue-900 leading-relaxed font-mono",children:w.medical_context})]}),b.jsxs("div",{className:"bg-green-50/50 rounded p-4 border-l-4 border-green-600",children:[b.jsx("p",{className:"text-xs font-bold mb-3 text-green-800",children:"✅ الحكم الشرعي والتفصيل:"}),b.jsx("p",{className:"text-sm leading-8 whitespace-pre-wrap text-gray-800 font-medium",children:w.ruling})]}),b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx("span",{className:"text-xs font-bold text-gray-600",children:"الحكم النهائي:"}),b.jsxs("span",{className:`text-xs font-bold px-3 py-1 rounded-full ${w.verdict==="PERMITTED"?"bg-green-100 text-green-800":w.verdict==="FORBIDDEN"?"bg-red-100 text-red-800":"bg-yellow-100 text-yellow-800"}`,children:[w.verdict==="PERMITTED"&&"✓ جائز",w.verdict==="FORBIDDEN"&&"✗ محرم",w.verdict==="CONDITIONAL"&&"◎ مشروط"]})]}),w.tags&&w.tags.length>0&&b.jsx("div",{className:"flex flex-wrap gap-2",children:w.tags.map((Ml,Wl)=>b.jsxs("span",{className:"text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full",children:["#",Ml]},Wl))})]})]},w.id))]})]},U.id)}),$&&b.jsx("div",{className:"flex justify-start w-full",children:b.jsxs("div",{className:"bg-white px-3 py-2 rounded-xl rounded-tl-none shadow-sm border border-gray-100 flex items-center gap-1",children:[b.jsx("div",{className:"w-1.5 h-1.5 bg-gray-400 rounded-full animate-bounce",style:{animationDelay:"0ms"}}),b.jsx("div",{className:"w-1.5 h-1.5 bg-gray-400 rounded-full animate-bounce",style:{animationDelay:"150ms"}}),b.jsx("div",{className:"w-1.5 h-1.5 bg-gray-400 rounded-full animate-bounce",style:{animationDelay:"300ms"}})]})})]}),b.jsxs("div",{className:"flex-shrink-0 px-3 py-3 bg-white border-t border-gray-100",children:[b.jsxs("button",{onClick:()=>p(!R),className:"w-full flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-teal-50 rounded-lg border border-blue-200 hover:shadow-md",children:[b.jsx("span",{className:`transition-transform ${R?"rotate-180":""}`,children:"▼"}),b.jsx("h3",{className:"text-sm font-bold text-gray-800",children:"📚 فهرس الموضوعات"})]}),R&&b.jsx("div",{className:"mt-2 bg-white border border-gray-200 rounded-lg p-3 space-y-2 max-h-64 overflow-y-auto",children:V===null?b.jsx("div",{className:"space-y-2",children:Ur.map(U=>b.jsx("button",{onClick:()=>{H(U.id),vl("category")},className:"w-full text-right p-2 bg-blue-50 hover:bg-blue-100 rounded text-xs font-semibold text-blue-700 transition font-amiri",children:U.name},U.id))}):b.jsxs("div",{className:"space-y-2",children:[b.jsx("button",{onClick:()=>H(null),className:"w-full text-right p-2 bg-gray-200 hover:bg-gray-300 rounded text-xs font-semibold text-gray-700 transition font-amiri",children:"← العودة"}),T.filter(U=>U.category===V).map(U=>b.jsx("button",{onClick:()=>{M([{id:Date.now().toString(),role:"user",text:U.question,isEmergency:!1},{id:(Date.now()+1).toString(),role:"model",text:U.title,isEmergency:!1,relatedFatwaIds:[U.id]}]),p(!1)},className:"w-full text-right p-2 bg-green-50 hover:bg-green-100 rounded text-xs font-semibold text-green-700 transition line-clamp-2 font-amiri",children:U.question},U.id))]})})]}),b.jsxs("div",{className:"relative w-full px-3 pt-3 pb-4 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent border-t border-gray-100",children:[b.jsxs("div",{className:"bg-white rounded-full shadow-[0_4px_20px_rgb(0,0,0,0.08)] border border-gray-100 p-1.5 flex items-center gap-2 w-full",children:[b.jsx("input",{type:"text",value:o,onChange:U=>q(U.target.value),onKeyDown:U=>U.key==="Enter"&&Hl(),placeholder:"سل ما تريد أو اكتب الكلمة المفتاحية",className:"flex-1 bg-transparent border-none focus:ring-0 px-4 text-gray-700 placeholder-gray-400 text-base h-10 font-tajawal",disabled:$}),b.jsx("button",{onClick:Hl,disabled:!o.trim()||$,className:`w-10 h-10 flex items-center justify-center rounded-full transition-all flex-shrink-0 ${o.trim()&&!$?"bg-teal-600 text-white hover:bg-teal-700 shadow-md rotate-0":"bg-gray-100 text-gray-300 cursor-not-allowed"}`,children:b.jsx(yf,{className:`w-4 h-4 ${document.dir==="rtl"?"rotate-180 mr-0.5":""}`})})]}),b.jsx("div",{className:"text-center mt-5 mb-0",children:b.jsx("p",{className:"text-[13px] text-gray-600 font-amiri leading-relaxed opacity-90",children:"(أخوكم وابنكم، محمد محمود الفيومي، كلية طب بنين القاهرة - جامعة الأزهر الشريف)"})})]})]}),Z==="category"&&V&&b.jsxs("section",{className:"flex-1 flex flex-col relative z-10 w-full mx-auto max-w-lg md:max-w-2xl",children:[b.jsxs("div",{className:"flex-1 overflow-y-auto p-3 md:p-5 space-y-3 pb-32 scrollbar-hide",children:[b.jsx("button",{onClick:()=>{vl("chat"),H(null)},className:"mb-4 p-2 bg-gray-200 hover:bg-gray-300 rounded text-xs font-semibold text-gray-700 transition font-amiri w-full text-right",children:"← العودة إلى الفهرس"}),b.jsx("h2",{className:"text-lg font-bold text-gray-900 font-amiri text-right mb-4",children:(Tl=Ur.find(U=>U.id===V))==null?void 0:Tl.name}),b.jsx("div",{className:"space-y-2",children:T.filter(U=>U.category===V).map(U=>b.jsx("button",{onClick:()=>{al(U),vl("fatwa")},className:"w-full text-right p-3 bg-green-50 hover:bg-green-100 rounded-lg border border-green-200 text-xs font-semibold text-green-800 transition font-amiri",children:U.question},U.id))})]}),b.jsx("div",{className:"relative w-full px-3 pt-3 pb-4 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent border-t border-gray-100",children:b.jsxs("div",{className:"bg-white rounded-full shadow-[0_4px_20px_rgb(0,0,0,0.08)] border border-gray-100 p-1.5 flex items-center gap-2 w-full",children:[b.jsx("input",{type:"text",value:o,onChange:U=>q(U.target.value),onKeyDown:U=>U.key==="Enter"&&Hl(),placeholder:"سل ما تريد أو اكتب الكلمة المفتاحية",className:"flex-1 bg-transparent border-none focus:ring-0 px-4 text-gray-700 placeholder-gray-400 text-base h-10 font-tajawal",disabled:$}),b.jsx("button",{onClick:Hl,disabled:!o.trim()||$,className:`w-10 h-10 flex items-center justify-center rounded-full transition-all flex-shrink-0 ${o.trim()&&!$?"bg-teal-600 text-white hover:bg-teal-700 shadow-md rotate-0":"bg-gray-100 text-gray-300 cursor-not-allowed"}`,children:b.jsx(yf,{className:`w-4 h-4 ${document.dir==="rtl"?"rotate-180 mr-0.5":""}`})})]})})]}),Z==="fatwa"&&F&&b.jsxs("section",{className:"flex-1 flex flex-col relative z-10 w-full mx-auto max-w-lg md:max-w-2xl",children:[b.jsxs("div",{className:"flex-1 overflow-y-auto p-3 md:p-5 space-y-4 pb-32 scrollbar-hide",children:[b.jsx("button",{onClick:()=>{vl("category"),al(null)},className:"mb-4 p-2 bg-gray-200 hover:bg-gray-300 rounded text-xs font-semibold text-gray-700 transition font-amiri w-full text-right",children:"← العودة إلى الأسئلة"}),b.jsxs("div",{className:"w-full rounded-xl shadow-md overflow-hidden border border-gray-200 bg-white",children:[b.jsxs("div",{className:"px-4 py-3 border-b flex justify-between items-center bg-gradient-to-r from-teal-50 to-blue-50 border-gray-100",children:[b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx(Mr,{className:"w-4 h-4 text-teal-600"}),b.jsx("span",{className:"text-xs font-bold text-teal-700",children:"فتوى تفصيلية"})]}),b.jsx("span",{className:"text-[11px] text-teal-700 bg-white/70 px-2 py-1 rounded font-semibold",children:F.source})]}),b.jsxs("div",{className:"p-4 space-y-4",children:[b.jsx("h3",{className:"font-bold text-lg font-amiri leading-snug text-gray-900 border-r-4 border-teal-600 pr-3 text-right",children:F.title}),b.jsxs("div",{className:"bg-amber-50/50 rounded p-3 border border-amber-100/50",children:[b.jsx("p",{className:"text-xs font-bold text-amber-800 mb-2 text-right",children:"❓ السؤال:"}),b.jsx("p",{className:"text-sm text-amber-900 leading-relaxed font-amiri text-right",children:F.question})]}),F.medical_context&&b.jsxs("div",{className:"bg-blue-50/50 rounded p-3 border border-blue-100/50",children:[b.jsx("p",{className:"text-xs font-bold text-blue-800 mb-2 text-right",children:"🏥 السياق الطبي:"}),b.jsx("p",{className:"text-sm text-blue-900 leading-relaxed font-amiri text-right",children:F.medical_context})]}),b.jsxs("div",{className:"bg-green-50/50 rounded p-4 border-l-4 border-green-600",children:[b.jsx("p",{className:"text-xs font-bold mb-3 text-green-800 text-right",children:"✅ الحكم الشرعي والتفصيل:"}),b.jsx("p",{className:"text-sm leading-8 whitespace-pre-wrap text-gray-800 font-medium font-amiri text-right",children:F.ruling})]}),b.jsxs("div",{className:"flex items-center gap-2 justify-end",children:[b.jsxs("span",{className:`text-xs font-bold px-3 py-1 rounded-full ${F.verdict==="PERMITTED"?"bg-green-100 text-green-800":F.verdict==="FORBIDDEN"?"bg-red-100 text-red-800":"bg-yellow-100 text-yellow-800"}`,children:[F.verdict==="PERMITTED"&&"✓ جائز",F.verdict==="FORBIDDEN"&&"✗ محرم",F.verdict==="CONDITIONAL"&&"◎ مشروط"]}),b.jsx("span",{className:"text-xs font-bold text-gray-600",children:"الحكم النهائي:"})]}),F.tags&&F.tags.length>0&&b.jsx("div",{className:"flex flex-wrap gap-2 justify-end",children:F.tags.map((U,Dl)=>b.jsxs("span",{className:"text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full font-amiri",children:["#",U]},Dl))})]})]})]}),b.jsx("div",{className:"relative w-full px-3 pt-3 pb-4 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent border-t border-gray-100",children:b.jsxs("div",{className:"bg-white rounded-full shadow-[0_4px_20px_rgb(0,0,0,0.08)] border border-gray-100 p-1.5 flex items-center gap-2 w-full",children:[b.jsx("input",{type:"text",value:o,onChange:U=>q(U.target.value),onKeyDown:U=>U.key==="Enter"&&Hl(),placeholder:"سل ما تريد أو اكتب الكلمة المفتاحية",className:"flex-1 bg-transparent border-none focus:ring-0 px-4 text-gray-700 placeholder-gray-400 text-base h-10 font-tajawal",disabled:$}),b.jsx("button",{onClick:Hl,disabled:!o.trim()||$,className:`w-10 h-10 flex items-center justify-center rounded-full transition-all flex-shrink-0 ${o.trim()&&!$?"bg-teal-600 text-white hover:bg-teal-700 shadow-md rotate-0":"bg-gray-100 text-gray-300 cursor-not-allowed"}`,children:b.jsx(yf,{className:`w-4 h-4 ${document.dir==="rtl"?"rotate-180 mr-0.5":""}`})})]})})]})]})]})},qr=document.getElementById("root");if(!qr)throw new Error("Could not find root element to mount to");const jy=vy.createRoot(qr);jy.render(b.jsx(fy.StrictMode,{children:b.jsx(Cy,{})}));
